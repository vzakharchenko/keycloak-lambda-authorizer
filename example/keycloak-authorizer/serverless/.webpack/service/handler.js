...
/* harmony import */ var _common_authorizerUtil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../common/authorizerUtil */ "../../common/authorizerUtil.js");
...
function getToken(event) {
  var headers = event.headers;
  var tokenString = headers ? headers.Authorization : null;
  ...
  var tokenStringValue = match[1];
  return jsonwebtoken__WEBPACK_IMPORTED_MODULE_1___default.a.decode(tokenStringValue);
}
...
function hello(event, context, callback) {
  ...
  callback(null, {
    statusCode: 200,
    body: JSON.stringify({
      message: "Hi ".concat(token.preferred_username, ". Your function executed successfully!")
    })
  });
}
function auth0(_x) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 5;
            return Object(_index__WEBPACK_IMPORTED_MODULE_3__["handler"])(event, keycloakJSON, {
              enforce: {
                enabled: true,
...
function auth(event, context, callback) {
  auth0(event).then(function (jwt) {
    Object(_common_authorizerUtil__WEBPACK_IMPORTED_MODULE_2__["getAuthentication"])(jwt).then(function (res) {
      callback(null, res);
    })["catch"](function (e) {

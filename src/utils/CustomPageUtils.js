...
function unauthorized(
  ...
  <body>
      ...
      <footer><p><a href="${getHostUrl(request)}">keycloak-lambda-authorizer</a></p></footer>
  </body>
  </html>
  `;

  page = page.replace(/%error%/g, error);
  page = page.replace(/%error_description%/g, errorDescription);
  page = page.replace(/%error_uri%/g, errorUri);
